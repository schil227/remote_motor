...
@Component({
  selector: 'app-videojs-stream',
  templateUrl: './videojs-stream.component.html',
  styleUrls: ['./videojs-stream.component.css']
})
export class VideojsStreamComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        if(!this.videoElement){
            throw 'videoPlayer element not found for ' + this.stream.name;
        }
