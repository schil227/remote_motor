...
if [ ! -e /var/www/html/streaming/streaming.html ]; then
        ln -s /home/adrian/remote_motor_repo/remote_motor/front_end/streaming.html /var/www/html/streaming/streaming.html
fi

#Mount Home streaming-temp directory to /dev/shm to get around wonky snapd security stuff:
# https://unix.stackexchange.com/questions/642324/ffmpeg-cannot-write-file-to-dev-shm-permission-denied
